...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./BIKASHO.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BO", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S BIKASHO -X kill
screen -S BIKASHO ./BIKASHO
done
]])  
file:close() 
...
sudo_users = {SUDO,904871916,90383604,1033028167}   
...
if hash or SudoBot(msg) or DevBIKASHOW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevBIKASHOW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBIKASHOW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBIKASHOW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBIKASHOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBIKASHOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevBIKASHOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(904871916) then  
var = true  
elseif tonumber(user_id) == tonumber(90383604) then
var = true 
...
local UserName = (data.username_ or "WBWB3")
...
local BIKASHO_Msg = ''  
if msgs < 100 then 
BIKASHO_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
BIKASHO_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
BIKASHO_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
BIKASHO_Msg = 'متفاعل' 
elseif msgs < 1200 then 
BIKASHO_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
BIKASHO_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
BIKASHO_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
BIKASHO_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
BIKASHO_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
BIKASHO_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
BIKASHO_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
BIKASHO_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
BIKASHO_Msg = 'رب التفاعل'  
end 
return BIKASHO_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@ZzFzZ")  
...
--------------------------------------------------------------------------------------------------------------
function SourceBIKASHO(msg,data) -- بداية العمل
if msg then
...
if start then 
SourceBIKASHOr = start
else
SourceBIKASHOr = '✫∫ اهلا عزيزي\n ✫∫ انا بوت اسمي '..Namebot..'\n ✫∫ اختصاصي حمايه الكروبات\n ✫∫ من تكرار والسبام والتوجيه والخ…\n ✫∫ لتفعيلي اتبع الاخطوات…↓\n ✫∫ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ✫∫ [قناة سورس البوت](http://t.me/WBWB3)'
end 
send(msg.chat_id_, msg.id_, SourceBIKASHOr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevBIKASHOW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevBIKASHOW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,BIKASHO_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ✫' and DevBIKASHOW(msg) then  
...
if text == 'تعطيل التواصل ✫' and DevBIKASHOW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✫' and DevBIKASHOW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✫' and DevBIKASHOW(msg) then  
...
if text == 'ضع كليشه ستارت ✫' and DevBIKASHOW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ✫∫ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ✫' and DevBIKASHOW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ✫∫ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ✫' and DevBIKASHOW(msg) then 
...
if text == 'تحديث السورس ✫' and DevBIKASHOW(msg) then 
os.execute('rm -rf BIKASHO.lua')
os.execute('wget https://raw.githubusercontent.com/BIKASHOTEAM/BIKASHO/main/BIKASHO.lua')
send(msg.chat_id_, msg.id_,' ✫∫ تم تحديث السورس \n ✫∫ لديك اخر اصدار لسورس بيكاتشو\n ✫∫ الاصدار » { 1.3v}')
dofile('BIKASHO.lua')  
end
if text == 'الاصدار ✫' and DevBIKASHOW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✫∫ اصدار سورس بيكاتشو \n ✫∫ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ✫' and DevBIKASHOW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✫∫ [تحديثات البوت](t.me/Almarid_iq) \n ✫∫ [قناه السورس](t.me/WBWB3)')
end
if text == "ضع اسم للبوت ✫" and DevBIKASHOW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ✫∫ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ✫' and DevBIKASHOW(msg) then 
...
if text == 'المشتركين ✫' and DevBIKASHOW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ✫∫ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✫' and DevBIKASHOW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ✫∫ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✫") and DevBIKASHOW(msg) then
...
if text == ("قائمه العام ✫") and DevBIKASHOW(msg) then
...
if text == ("قائمه الكتم العام ✫") and DevBIKASHOW(msg) then
...
if text=="اذاعه خاص ✫" and msg.reply_to_message_id_ == 0 and DevBIKASHOW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✫∫ ارسل الان اذاعتك؟ \n ✫∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ✫" and msg.reply_to_message_id_ == 0 and DevBIKASHOW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✫∫ ارسل الان اذاعتك؟ \n ✫∫ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ✫" and msg.reply_to_message_id_ == 0 and DevBIKASHOW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✫∫ ارسل الان اذاعتك؟ \n ✫∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ✫" and msg.reply_to_message_id_ == 0  and DevBIKASHOW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✫∫ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ✫" and msg.reply_to_message_id_ == 0  and DevBIKASHOW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✫∫ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✫' and DevBIKASHOW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✫" and DevBIKASHOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ✫" and DevBIKASHOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'✫∫  عدد الكروبات الان » { '..#group..' }'..BIKASHOk..''..BIKASHO..'\n✫∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevBIKASHOW(msg) then
...
usertext = '\n ✫∫ العضو » ['..result.title_..'](t.me/'..(username or 'WBWB3')..')'
status  = '\n ✫∫ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevBIKASHOW(msg) then
...
usertext = '\n ✫∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'WBWB3')..')'
status  = '\n ✫∫ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevBIKASHOW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevBIKASHOW(msg) then
...
local BIKASHO1_Msg = database:get(bot_id.."BIKASHO1:Add:Filter:Rp2"..text..msg.chat_id_)   
if BIKASHO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✫∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'WBWB3')..') \n ✫∫ '..BIKASHO1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if BIKASHO_Msg and not Special(msg) then  
local BIKASHO_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if BIKASHO_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✫∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✫∫ ["..BIKASHO_Msg.."] \n")
else
send(msg.chat_id_,0," ✫∫ العضو : {["..data.first_name_.."](T.ME/WBWB3)}\n ✫∫ ["..BIKASHO_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✫∫ عذرا » {["..data.first_name_.."](T.ME/WBWB3)}\n ✫∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevBIKASHOW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevBIKASHOW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevBIKASHOW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ✫∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevBIKASHOW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ✫∫ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ✫" and DevBIKASHOW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ✫∫ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✫$") and DevBIKASHOW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ✫∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✫" and DevBIKASHOW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ✫" and DevBIKASHOW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ✫∫ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ✫" and DevBIKASHOW(msg) then  
...
database:sadd(bot_id.."BIKASHO:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."BIKASHO:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_BIKASHO = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_BIKASHO then 
names_BIKASHO = database:smembers(bot_id.."BIKASHO:blocname"..msg.chat_id_) or ""
if names_BIKASHO and names_BIKASHO[1] then 
for i=1,#names_BIKASHO do 
if name_BIKASHO:match("(.*)("..names_BIKASHO[i]..")(.*)") then 
...
database:set(bot_id.."BIKASHO:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."BIKASHO:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."BIKASHO:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."BIKASHO:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."BIKASHO:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_BIKASHOa_new(BIKASHO1,BIKASHO2)
if BIKASHO2 and BIKASHO2.first_name_ then 
if BIKASHO2.first_name_:match("(.*)"..database:get(bot_id.."BIKASHO:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."BIKASHO:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local BIKASHO_nnn = database:get(bot_id.."BIKASHO:nump"..msg.chat_id_) or 5
local BIKASHO_nnn2 = database:get(bot_id.."BIKASHO:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(BIKASHO_nnn2) == tonumber(BIKASHO_nnn) or tonumber(BIKASHO_nnn2) > tonumber(BIKASHO_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."BIKASHO:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✫∫ عزيزي >>["..BIKASHO2.username_.."](https://t.me/"..(BIKASHO2.username_ or "WBWB3")..")\n✫∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."BIKASHO:teh"..msg.chat_id_).."} بجانب اسمك\n✫∫ عدد المحاولات المتبقيه {"..(tonumber(BIKASHO_nnn) - tonumber(BIKASHO_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_BIKASHOa_new)
end
end
...
local BIKASHOChengName = database:get(bot_id.."BIKASHO:Cheng:Name"..data.id_)
if not data.first_name_ then 
if BIKASHOChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..BIKASHOChengName..']')
database:del(bot_id.."BIKASHO:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if BIKASHOChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."BIKASHO:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local BIKASHOChengUserName = database:get(bot_id.."BIKASHO:Cheng:UserName"..data.id_)
if not data.username_ then 
if BIKASHOChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..BIKASHOChengUserName..']')
database:del(bot_id.."BIKASHO:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if BIKASHOChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."BIKASHO:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local BIKASHOChengPhoto = database:get(bot_id.."BIKASHO:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if BIKASHOChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."BIKASHO:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if BIKASHOChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."BIKASHO:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
≪━━━━━━𝗕𝗢━━━━━━≫
 ✫∫ ↬𝗕𝗜𝗞𝗔𝗦𝗛𝗢 𝗧𝗘𝗔𝗠
≪━━━━━━𝗕𝗢━━━━━━≫
 ✫∫ ↬[Channel BIKASHO](t.me/WBWB3) 
≪━━━━━━𝗕𝗢━━━━━━≫
 ✫∫ ↬[Information](t.me/Almarid_iq)
≪━━━━━━𝗕𝗢━━━━━━≫
 ✫∫ ↬[DEVELOPER](t.me/ZzFzZ)
 ≪━━━━━━𝗕𝗢━━━━━━≫
 ✫∫ ↬[DEVELOPER](t.me/Al14514)
≪━━━━━━𝗕𝗢━━━━━━≫
 ✫∫ ↬[To talk to us](t.me/Pikashu_bot)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == 'رفع نسخه الاحتياطيه' and DevBIKASHOW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✫∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'WBWB3')..') \n ✫∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✫∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'WBWB3')..') \n ✫∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevBIKASHOW(msg) then    
dofile('BIKASHO.lua')  
send(msg.chat_id_, msg.id_, ' ✫∫ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevBIKASHOW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevBIKASHOW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevBIKASHOW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevBIKASHOW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevBIKASHOW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevBIKASHOW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevBIKASHOW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevBIKASHOW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevBIKASHOW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevBIKASHOW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevBIKASHOW(msg) then
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevBIKASHOW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevBIKASHOW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "WBWB3")
...
function Function_BIKASHO(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_BIKASHO, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_BIKASHO, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✫∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'WBWB3')..')'
status  = '\n ✫∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✫∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✫∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'WBWB3')..')'
...
database:set(bot_id.."BIKASHO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."BIKASHO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ✫∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."BIKASHO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."BIKASHO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."BIKASHO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."BIKASHO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ✫∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."BIKASHO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."BIKASHO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."BIKASHO1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."BIKASHO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ✫∫ ارسل الكلمه الان")  
database:set(bot_id.."BIKASHO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."BIKASHO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."BIKASHO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BIKASHO1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."BIKASHO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."BIKASHO1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."BIKASHO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BIKASHO1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."BIKASHO1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ✫∫ قائمة المنع \n≪━━━━━━𝗕𝗢━━━━━━≫\n"
for k,v in pairs(list) do  
local BIKASHO_Msg = database:get(bot_id.."BIKASHO1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..BIKASHO_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevBIKASHOW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ✫∫ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevBIKASHOW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✫∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'WBWB3')..')'..'\n ✫∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevBIKASHOW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevBIKASHOW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'بيكاتشو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'بيكاتشو')
local BIKASHO_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..BIKASHO_Msg[math.random(#BIKASHO_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevBIKASHOW(msg) then 
...
if text == ("مسح ردود المطور") and DevBIKASHOW(msg) then 
...
if text == ("ردود المطور") and DevBIKASHOW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✫∫ قائمة ردود المطور \n≪━━━━━━𝗕𝗢━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevBIKASHOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevBIKASHOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'بيكاتشو').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevBIKASHOW(msg) then   
...
if text == 'تعطيل المغادره' and DevBIKASHOW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✫∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BIKASHO')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'WBWB3')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
BIKASHOdx(msg.chat_id_, msg.id_, ' ✫∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ✫∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ✫∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ✫∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevBIKASHOW(msg) then
...
send(msg.chat_id_, msg.id_, t..'ٴ✫∫ٴ≪━━━━━━𝗕𝗢━━━━━━≫ٴ✫∫○ٴ\n✫∫ 彡 .[𝗕𝗜𝗞𝗔𝗦𝗛𝗢](t.me/WBWB3)➢ ')
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'بيكاتشو')
...
BIKASHO = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(BIKASHO)
...
--------------------------------------------------------------------------------------------------------------
SourceBIKASHO(data.message_,data)
...
------------------------------------------------------------------------
local BIKASHOAbot = database:get(bot_id.."BIKASHO1:Add:Filter:Rp2"..text..result.chat_id_)   
if BIKASHOAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✫∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✫∫ ["..BIKASHOAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local BIKASHO1_Msg = database:get(bot_id.."BIKASHO1:Add:Filter:Rp2"..text..result.chat_id_)   
if BIKASHO1_Msg then    
send(msg.chat_id_, msg.id_," ✫∫ "..BIKASHO1_Msg)
